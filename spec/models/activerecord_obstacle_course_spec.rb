...
# ----------------------
  ...
  it '4. finds orders of multiple amounts' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_of_500_and_700 = Order.where(amount: 500) + Order.where(amount: 700)
    orders_of_700_and_1000 = Order.where(amount: 700) + Order.where(amount: 1000)
    # ------------------------------------------------------------
  ...
  it '5. finds multiple items by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    items = Item.select(items: ids_to_find)
    # ------------------------------------------------------------
